...
public abstract class AbstractAzureBaseDestinationAcceptanceTest extends DestinationAcceptanceTest {

  protected static final Logger LOGGER = LoggerFactory
      .getLogger(AbstractAzureBaseDestinationAcceptanceTest.class);
  ...
  protected AbstractAzureBaseDestinationAcceptanceTest(final AzureBlobStorageFormat outputFormat) {
    this.outputFormat = outputFormat;
  }

  abstract protected JsonNode getBaseConfigJson();
